function [centres, options, post, errlog] = kmeans(data, ncentres)
...
centres = zeros(ncentres, size(data,2));
options = zeros(1,14);
options(1) = 0; % affichage
options(2) = 1;
options(3) = 0.1; % precision
options(5) = 1; % initialisation
options(14) = 100; % nombre maximum d'iterations
